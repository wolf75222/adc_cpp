...
#include <adc/core/foundation/cold.hpp>  // ADC_COLD_FN: COLD-factory no-optimize attribute (ADC-337)
#include <adc/core/state/variables.hpp>  // VariableSet/VariableRole/role_from_name/roles_csv (resolve_implicit_components)
#include <adc/physics/bricks/bricks.hpp>
#include <adc/runtime/dynamic/model_registry.hpp>  // kTransports/kSources/kElliptics: builtin-brick tag registry (ADC-331)
...
inline ADC_COLD_FN std::vector<int> resolve_implicit_components(
...
inline ADC_COLD_FN int resolve_selected_component(const std::string& origin,
