...
#include <adc/coupling/schur/source/condensed_schur_source_stepper.hpp>  // CondensedSchurSourceStepper (#126) + detail kernels
#include <adc/amr/hierarchy/refinement_ratio.hpp>
#include <adc/coupling/schur/core/schur_condensation.hpp>  // ElectrostaticLorentzCondensation (assemble per level)
