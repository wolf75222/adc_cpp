...
///
/// POD struct, zero allocation, trivially copyable. All accessors POPS_HD.
...
struct LorentzEliminator {
  ...
  /// @{
  POPS_HD Real binv_11() const { return Real(1) / det; }
  POPS_HD Real binv_12() const { return w / det; }
  POPS_HD Real binv_21() const { return -w / det; }
  POPS_HD Real binv_22() const { return Real(1) / det; }
  /// @}
};
