...
///   POPS_HD lambdas: first instantiation from an external loader TU would trip nvcc; body strictly
...
// NAMED FUNCTORS (and not POPS_HD lambdas) for the AMR reflux device kernels. Same reasons as the
