...
that algebra IN LOOPS over the DSL AST (pops.dsl): the equivalent of a symbolic toolbox
...
def build_moment_model(name, order, closure, blocks=None, exact_speeds=True,
    ...
    @return pops.dsl.Model ready to compile (the caller may still add elliptic_rhs, params,
