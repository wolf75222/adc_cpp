...
# resolves C++ symbols exported by the _pops extension (System::install_block,
...
# load _pops with RTLD_GLOBAL, then restore the flags for the following imports.
...
# the generic headers of adc_cpp. It is therefore neither re-exported here nor present in the _pops module.
__all__ = [
...
# system via pops.System(mesh=...). pops.CartesianMesh is the implicit default (square domain, numerics
# STRICTLY unchanged, bit-identical). pops.PolarMesh describes a global ring (r, theta).
class CartesianMesh:
